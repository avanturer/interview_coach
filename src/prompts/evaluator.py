...
Формат JSON:
- Не используй кавычки внутри строк (summary, correct_answer и т.д.) — заменяй на апостроф или пиши без цитирования.
- Без trailing comma перед }} или ].
- Краткие summary и correct_answer (до 2-3 предложений) — длинный текст чаще ломает JSON.
